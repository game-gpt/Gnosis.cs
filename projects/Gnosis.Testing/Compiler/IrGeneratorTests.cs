...
public class IrGeneratorTests
{
    ...
    private static AttributeDecl VertexAttr() => new(null, "Vertex", Array.Empty<KeyValuePair<string, string>>());
    ...
    public void VisitLiteralExpr_IntLiteral_ContainsValue()
    {
        ...
        var func = ir.Functions[0];
        var load = func.Instructions.OfType<LoadInstruction>().FirstOrDefault();
    ...
    public void VisitBinaryExpr_LogicalAnd_GeneratesLogicalInstruction()
    {
        var ast = CreateCompilationUnit(
            new FunctionDecl(null, "main", Array.Empty<ParameterDecl>(),
                ...
                new BlockStmt(null, new AstNode[]
                {
                    new VariableDecl(null, "a", new TypeAnnotation(null, "bool", Array.Empty<TypeAnnotation>()), new LiteralExpr(null, LiteralType.Boolean, true), false),
                    new VariableDecl(null, "b", new TypeAnnotation(null, "bool", Array.Empty<TypeAnnotation>()), new LiteralExpr(null, LiteralType.Boolean, false), false),
    ...
    public void VisitForStmt_GeneratesLoopMergeAndBranches()
    {
        var ast = CreateCompilationUnit(
            new FunctionDecl(null, "main", Array.Empty<ParameterDecl>(),
                new TypeAnnotation(null, "void", Array.Empty<TypeAnnotation>()),
                new BlockStmt(null, new AstNode[]
                {
                    new ForStmt(null,
    ...
    {
        var ast = CreateCompilationUnit(
            new SystemDecl(null, "MoveSystem", Array.Empty<AttributeDecl>(), Array.Empty<QueryExpr>(), Array.Empty<FunctionDecl>()));
    ...
    {
        var ast = CreateCompilationUnit(
            new LoopStmt(null, "item", new IdentifierNode(null, "items"), new BlockStmt(null, Array.Empty<AstNode>())));
