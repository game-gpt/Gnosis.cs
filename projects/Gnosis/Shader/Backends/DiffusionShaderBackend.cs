...
public sealed class DiffusionShaderBackend : IShaderBackend
{
    ...
    public bool SupportsKind(MicroFunctionKind kind) =>
        kind is MicroFunctionKind.Diffusion or MicroFunctionKind.Vertex or MicroFunctionKind.Fragment;
    ...
    private static ShaderFunctionIr MapFunction(IMicroFunction func)
    {
        var executionModel = func.Kind switch
        {
            ...
            MicroFunctionKind.Diffusion => ShaderExecutionModel.Fragment,
    ...
    private static ShaderIrType MapParameterType(ShaderParameterType type) => type switch
    {
        ...
        ShaderParameterType.UInt32 => new ShaderIrType.IntType(32, false),
        ...
        ShaderParameterType.DiffusionModel => new ShaderIrType.ExternalType("diffusion_model"),
