...
public abstract class Widget : IWidget
{
    ...
    WidgetVisibility IWidget.Visibility
    {
        ...
        {
            Visibility.Visible => WidgetVisibility.Visible,
            Visibility.Hidden => WidgetVisibility.Hidden,
            Visibility.Collapsed => WidgetVisibility.Collapsed,
            _ => WidgetVisibility.Visible
        };
        set => Visibility = value switch
        {
            WidgetVisibility.Visible => Visibility.Visible,
            WidgetVisibility.Hidden => Visibility.Hidden,
            WidgetVisibility.Collapsed => Visibility.Collapsed,
