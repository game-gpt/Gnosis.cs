...
{
    public float Rate { get => throw new NotImplementedException("粒子系统尚未实现"); set => throw new NotImplementedException("粒子系统尚未实现"); }
    ...
    public float MaxSpeed { get => throw new NotImplementedException("粒子系统尚未实现"); set => throw new NotImplementedException("粒子系统尚未实现"); }
    public int MaxParticles { get => throw new NotImplementedException("粒子系统尚未实现"); set => throw new NotImplementedException("粒子系统尚未实现"); }
    public bool UseGpuSimulation { get => throw new NotImplementedException("粒子系统尚未实现"); set => throw new NotImplementedException("粒子系统尚未实现"); }
    public void Emit(int count) { throw new NotImplementedException("粒子系统尚未实现"); }
    public void Reset() { throw new NotImplementedException("粒子系统尚未实现"); }
}
